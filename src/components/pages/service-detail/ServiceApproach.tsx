...
export function ServiceApproach({ detail }: { detail: ServiceDetail }) {
  return (
    <section className="relative overflow-hidden bg-ink py-16 text-paper md:py-24">
      <CursorAtmosphere tone="dark" />
      <Container className="relative">
        <SectionHeader tone="dark" eyebrow="The GraphikosX Approach" title="Strategy before execution, applied here." />
