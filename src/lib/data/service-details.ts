...
export const serviceDetails: Record<string, ServiceDetail> = {
  "brand-strategy": {
    ...
    definitionAnswer:
      "Brand strategy is the set of decisions, including positioning, audience, narrative and differentiation, that determine what a business communicates and why, before any design or content work begins. It is the reasoning layer underneath the visual identity, not the visual identity itself.",
    definitionExpansion:
      "In practice, it means answering a small number of hard questions clearly: who is this genuinely for, what do they actually compare this business against, and what is true about this business that a competitor cannot credibly copy. Everything downstream, from the website’s headline to the tone of the content to the industries a business chooses to focus on, inherits its logic from these answers.",
    whenYouNeedIt: [
  ...
  "visual-identity": {
    ...
    industries: ["architecture-interior", "jewellery-wedding"],
    faqs: [
      ...
      { q: "Who uses the guidelines day to day?", a: "Anyone producing brand-facing material, including internal team members, freelancers, or future agencies, so the brand stays consistent regardless of who is executing." },
    ...
    metaDescription: "A consistent visual identity system, covering logo usage, color, typography and imagery, built to stay coherent across the website, social and every future touchpoint.",
  },
  "business-websites": {
    ...
    industries: ["healthcare", "legal-professional-services", "real-estate", "architecture-interior", "financial-services-wealth-management"],
    faqs: [
  ...
  "landing-pages": {
    ...
    faqs: [
      ...
      { q: "Do we need one landing page per campaign?", a: "Generally yes, if the campaigns target different audiences or offers, since a shared page dilutes the message for all of them." },
  ...
  "digital-infrastructure": {
    ...
    problem: [
      "Most businesses do not think about their technical foundation until something breaks: a domain about to expire, analytics that were never set up, a website that goes down with no one able to explain why. By then, the cost of not having it is already being paid in lost data, downtime or a scramble to fix things under pressure.",
      "This is rarely a visible problem, which is exactly why it tends to get skipped. But every other digital effort, from the website to SEO to ad campaigns, sits on top of this foundation, and inherits its weaknesses.",
    ],
    definitionAnswer:
    ...
    outcomeHeadline: "Credibility",
    outcomeBody:
      "Solid infrastructure does not generate leads on its own, but it is what makes every number reported elsewhere trustworthy. Without reliable tracking, a business cannot actually know whether its website, SEO or campaigns are working, and every other outcome depends on this being right first.",
    ecosystem: ["business-websites", "crm-integration"],
    industries: ["industrial-manufacturing-chemicals", "healthcare", "legal-professional-services", "financial-services-wealth-management"],
    faqs: [
  ...
  "social-media-management": {
    ...
    industries: ["fitness-wellness", "automotive-ev", "jewellery-wedding"],
    faqs: [
      ...
      { q: "How is success measured here?", a: "Against the goals defined in strategy, such as visibility, engagement, or supporting another channel like lead generation, not vanity metrics alone." },
  ...
  "seo": {
    ...
    industries: ["healthcare", "legal-professional-services", "real-estate", "industrial-manufacturing-chemicals", "financial-services-wealth-management"],
    faqs: [
      { q: "How long does SEO take to show results?", a: "It varies by competitiveness and starting point, but SEO is a compounding channel, not an instant one, and meaningful movement is typically measured in months, not weeks." },
  ...
  "google-business-profile": {
    ...
    industries: ["fitness-wellness", "healthcare", "jewellery-wedding"],
    faqs: [
  ...
  "content-production": {
    ...
    industries: ["legal-professional-services", "industrial-manufacturing-chemicals", "jewellery-wedding", "financial-services-wealth-management"],
    faqs: [
      ...
      { q: "How does this support SEO?", a: "Search engines reward content that genuinely answers what people are searching for, and well-produced content is one of the main inputs SEO strategy depends on." },
    ],
  ...
  "linkedin-personal-branding": {
    ...
    industries: ["architecture-interior", "legal-professional-services", "industrial-manufacturing-chemicals", "financial-services-wealth-management"],
    faqs: [
      ...
      { q: "How is success measured?", a: "Against relevant engagement and reach among the right audience, such as connections and comments from people who could plausibly become customers or referrers, not vanity follower counts." },
    ],
  ...
  "ai-automation": {
    ...
    definitionAnswer:
      "AI automation is the use of AI-driven tools to handle repetitive, well-defined tasks, such as research, data entry, routine follow-ups, and scheduling, so that human time is spent on the decisions and relationships that actually require it.",
    definitionExpansion:
    ...
    faqs: [
      ...
      { q: "What kinds of tasks are realistic to automate?", a: "Well-defined, repetitive processes, such as routine follow-ups, data entry, scheduling, and initial inquiry responses, rather than anything requiring nuanced judgment or relationship handling." },
  ...
  "workflow-automation": {
    ...
    definitionAnswer:
      "Workflow automation is the practice of connecting a business's tools and steps so that routine processes, such as onboarding, notifications, status updates, and handoffs, happen automatically and consistently, instead of depending on someone remembering to do them manually.",
    definitionExpansion:
  ...
  "lead-generation-systems": {
    ...
    faqs: [
      ...
      { q: "How quickly will leads start coming in?", a: "It depends on the channels involved, since some produce results faster than others, and is discussed realistically during strategy, not oversold upfront." },
    ...
    metaDescription: "Structured lead generation systems, with channels, landing pages and follow-up built together, so pipeline growth stops depending on referrals alone.",
  },
  "marketing-consultation": {
    ...
    problem: [
      "Businesses often know they need \"more marketing\" without a clear view of which specific investment, such as a website, SEO, content, or automation, would actually move things forward first. Without that clarity, budget tends to go toward whatever was pitched most recently, not what the business most needs.",
